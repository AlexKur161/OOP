...
window.addEventListener('DOMContentLoaded', function () {
  var slider = new _modules_slider_mainSlider_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
    container: '.page',
    btns: '.next'
  });
  slider.render();
  var video = new _modules_playVideo_js__WEBPACK_IMPORTED_MODULE_2__["default"]('.overlay', '.showup__video .play', '.close');
  video.init();
  var childrenSlider = new _modules_slider_miniSlider_js__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  var exploreSlider = new _modules_slider_miniSlider_js__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  var feedSlider = new _modules_slider_miniSlider_js__WEBPACK_IMPORTED_MODULE_1__["default"]({
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return StartVideo; });
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__);
...
/*#__PURE__*/
function () {
  function StartVideo(overlay, btn, close) {
    _classCallCheck(this, StartVideo);
  ...
  _createClass(StartVideo, [{
    ...
    value: function btnEvent() {
      ...
      this.close.forEach(function (itemClose) {
...
/* harmony import */ var _slider__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../slider */ "./src/js/modules/slider.js");
...
function (_Slider) {
  ...
  _createClass(MainSlider, [{
    ...
    value: function slideIndex(i) {
      ...
      var sectionSlides = Array.from(this.slides);
      var show = sectionSlides.findIndex(function (sl) {
        return sl == _this.modulesSection;
      });

      if (show === this.indexPage) {
        var modalOpen = document.querySelector('.hanson');
        setTimeout(function () {
...
/* harmony import */ var _mainSlider__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./mainSlider */ "./src/js/modules/slider/mainSlider.js");
...
function (_MainSlider) {
  _inherits(MiniSlider, _MainSlider);

  function MiniSlider(container, next, prev, activeClass, animation, autoPlay) {
    _classCallCheck(this, MiniSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, container, next, prev, activeClass, animation, autoPlay));
  }

  _createClass(MiniSlider, [{
    key: "flexContainer",
    value: function flexContainer() {
    ...
    value: function triggerClass() {
      ...
      if (this.animation) {
        this.slides.forEach(function (slide) {
          slide.querySelector(_this.animation).style.opacity = 0.4;
    ...
    value: function slideIndex() {
      ...
      this.prev.addEventListener('click', function () {
        if (Array.from(_this2.slides).find(function (item) {
          return item.tagName == 'BUTTON';
        })) {
          var divSlide = Array.from(_this2.slides).filter(function (item) {
            return item.tagName == 'DIV';
          });
          var prevSlide = divSlide[divSlide.length - 1];

          _this2.container.prepend(prevSlide);

          _this2.triggerClass();
        } else {
          var prevSlideChild = _this2.slides[_this2.slides.length - 1];

          _this2.container.prepend(prevSlideChild);
  ...
  return MiniSlider;
}(_mainSlider__WEBPACK_IMPORTED_MODULE_12__["default"]);
